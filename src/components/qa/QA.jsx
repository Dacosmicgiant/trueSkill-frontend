...
const RepoQuestions = () => {
  ...
  const handleFetchQuestions = async () => {
    ...
    try {
      const response = await fetch(`https://innohaxbackend.pythonanywhere.com/api/questions/${repoName}`);
  ...
  const handleSubmitAnswer = async () => {
    ...
    try {
      const response = await fetch('https://innohaxbackend.pythonanywhere.com/api/submit_answer', {
        method: 'POST',
  ...
  const fetchResults = async () => {
    try {
      const response = await fetch('https://innohaxbackend.pythonanywhere.com/api/results');
      const data = await response.json();
